...
public class SaveFile : MonoBehaviour
{
	...
	//    }
	//    /*GUI  buttons to testing if save and read works*/
	//    void OnGUI()
	//    {
	//        if (showWindow == true)
	//        {
	...
	//                save();
	//            }
	//            if (GUI.Button(new Rect(550, 200, 100, 20), "Read"))
	//            {
	//                read();
	//            }
	//        }
	...
	//        {
	//            Load_cards = sr.ReadLine().Split(',').Select(n => Convert.ToInt32(n)).ToArray();
	//        }
